...
GPIO_PinConfig gpioPinConfigs[CONFIG_GPIO_COUNT] = {
    ...
    /* CONFIG_GPIO_4 */
    GPIOMSP432E4_PK5 | GPIO_DO_NOT_CONFIG,
    /* CONFIG_GPIO_5 */
    GPIOMSP432E4_PD4 | GPIO_CFG_IN_NOPULL | GPIO_CFG_IN_INT_NONE,
    /* CONFIG_GPIO_SWITCH_6 : LaunchPad Button USR_SW1 (Left) */
    GPIOMSP432E4_PJ0 | GPIO_CFG_IN_PU | GPIO_CFG_IN_INT_FALLING,
    /* CONFIG_GPIO_SWITCH_7 : LaunchPad Button USR_SW2 (Right) */
...
const uint_least8_t CONFIG_GPIO_SWITCH_6_CONST = CONFIG_GPIO_SWITCH_6;
const uint_least8_t CONFIG_GPIO_SWITCH_7_CONST = CONFIG_GPIO_SWITCH_7;
