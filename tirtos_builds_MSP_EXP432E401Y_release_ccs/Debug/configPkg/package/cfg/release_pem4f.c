...
/* --> uartReadTask */
extern xdc_Void uartReadTask(xdc_UArg f_arg0,xdc_UArg f_arg1);
...
ti_sysbios_knl_Task_Object__ ti_sysbios_knl_Task_Object__table__V[5] = {
    {/* instance#0 */
        ...
        0,  /* stackHeap */
        ((xdc_Void(*)(xdc_UArg f_arg0,xdc_UArg f_arg1))(uartReadTask)),  /* fxn */
        ((xdc_UArg)(0x0)),  /* arg0 */
        ((xdc_UArg)(0x0)),  /* arg1 */
        ((xdc_Ptr)NULL),  /* env */
...
const ti_sysbios_gates_GateSwi_Handle gateSwi0 = (ti_sysbios_gates_GateSwi_Handle)((ti_sysbios_gates_GateSwi_Handle)&ti_sysbios_gates_GateSwi_Object__table__V[0]);
    ...
    __attribute__ ((used))
const ti_sysbios_knl_Task_Handle UARTReader = (ti_sysbios_knl_Task_Handle)((ti_sysbios_knl_Task_Handle)&ti_sysbios_knl_Task_Object__table__V[0]);
