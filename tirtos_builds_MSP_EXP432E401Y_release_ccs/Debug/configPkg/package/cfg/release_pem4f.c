...
/* --> timer0SWI */
extern xdc_Void timer0SWI(xdc_UArg f_arg0,xdc_UArg f_arg1);

/* --> sw1SWI */
extern xdc_Void sw1SWI(xdc_UArg f_arg0,xdc_UArg f_arg1);

/* --> sw2SWI */
extern xdc_Void sw2SWI(xdc_UArg f_arg0,xdc_UArg f_arg1);
...
__T1_ti_sysbios_knl_Task_Instance_State__stack ti_sysbios_knl_Task_Instance_State_0_stack__A[2048] __attribute__ ((section(".bss:taskStackSection"), aligned(8)));
#endif

/* --> uart0ReadTask */
extern xdc_Void uart0ReadTask(xdc_UArg f_arg0,xdc_UArg f_arg1);
...
/* --> uartWriteTask */
extern xdc_Void uartWriteTask(xdc_UArg f_arg0,xdc_UArg f_arg1);
...
/* --> executePayloadTask */
extern xdc_Void executePayloadTask(xdc_UArg f_arg0,xdc_UArg f_arg1);
...
extern xdc_Void tickerProcessingTask(xdc_UArg f_arg0,xdc_UArg f_arg1);
...
#if !(defined(__MACH__) && defined(__APPLE__))
__T1_ti_sysbios_knl_Task_Instance_State__stack ti_sysbios_knl_Task_Instance_State_4_stack__A[512] __attribute__ ((section(".bss:taskStackSection"), aligned(8)));
#endif

/* --> uart1ReadTask */
extern xdc_Void uart1ReadTask(xdc_UArg f_arg0,xdc_UArg f_arg1);
...
#if !(defined(__MACH__) && defined(__APPLE__))
__T1_ti_sysbios_knl_Task_Instance_State__stack ti_sysbios_knl_Task_Instance_State_5_stack__A[2048] __attribute__ ((section(".bss:taskStackSection"), aligned(8)));
#endif
...
#if !(defined(__MACH__) && defined(__APPLE__))
__T1_ti_sysbios_knl_Task_Instance_State__stack ti_sysbios_knl_Task_Instance_State_6_stack__A[512] __attribute__ ((section(".bss:taskStackSection"), aligned(8)));
#endif
 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = C:/Users/priva/OneDrive - Texas Tech University/Documents/ccs_workspace/tirtos_builds_MSP_EXP432E401Y_release_ccs/Debug/configPkg/package/cfg/release_pem4f");
...
__FAR__ const CT__ti_sysbios_BIOS_Module__id ti_sysbios_BIOS_Module__id__C = (xdc_Bits16)0x27;
...
__FAR__ const CT__ti_sysbios_family_arm_lm4_Seconds_Module__id ti_sysbios_family_arm_lm4_Seconds_Module__id__C = (xdc_Bits16)0x2f;
...
__FAR__ const CT__ti_sysbios_family_arm_msp432e4_init_Boot_Module__id ti_sysbios_family_arm_msp432e4_init_Boot_Module__id__C = (xdc_Bits16)0x29;
...
__FAR__ const CT__ti_sysbios_gates_GateHwi_Module__id ti_sysbios_gates_GateHwi_Module__id__C = (xdc_Bits16)0x20;
...
__FAR__ const CT__ti_sysbios_gates_GateMutex_Module__id ti_sysbios_gates_GateMutex_Module__id__C = (xdc_Bits16)0x22;
...
__FAR__ const CT__ti_sysbios_gates_GateSwi_Module__id ti_sysbios_gates_GateSwi_Module__id__C = (xdc_Bits16)0x21;
...
ti_sysbios_knl_Swi_Object__ ti_sysbios_knl_Swi_Object__table__V[4] = {
    {/* instance#0 */
        ...
        ((xdc_Void(*)(xdc_UArg f_arg0,xdc_UArg f_arg1))(timer0SWI)),  /* fxn */
        ((xdc_UArg)(0x0)),  /* arg0 */
        ((xdc_UArg)(0x0)),  /* arg1 */
    ...
    {/* instance#1 */
        ...
        ((xdc_Void(*)(xdc_UArg f_arg0,xdc_UArg f_arg1))(sw1SWI)),  /* fxn */
        ((xdc_UArg)(0x0)),  /* arg0 */
        ((xdc_UArg)(0x0)),  /* arg1 */
    ...
    {/* instance#2 */
        ...
        ((xdc_Void(*)(xdc_UArg f_arg0,xdc_UArg f_arg1))(sw2SWI)),  /* fxn */
        ((xdc_UArg)(0x0)),  /* arg0 */
        ((xdc_UArg)(0x0)),  /* arg1 */
        (xdc_UInt)0xf,  /* priority */
        (xdc_UInt)0x8000,  /* mask */
...
ti_sysbios_knl_Task_Object__ ti_sysbios_knl_Task_Object__table__V[7] = {
    {/* instance#0 */
        ...
        0,  /* stackHeap */
        ((xdc_Void(*)(xdc_UArg f_arg0,xdc_UArg f_arg1))(uart0ReadTask)),  /* fxn */
        ((xdc_UArg)(0x0)),  /* arg0 */
        ((xdc_UArg)(0x0)),  /* arg1 */
        ((xdc_Ptr)NULL),  /* env */
    ...
    {/* instance#1 */
        ...
        0,  /* stackHeap */
        ((xdc_Void(*)(xdc_UArg f_arg0,xdc_UArg f_arg1))(uartWriteTask)),  /* fxn */
        ((xdc_UArg)(0x0)),  /* arg0 */
        ((xdc_UArg)(0x0)),  /* arg1 */
        ((xdc_Ptr)NULL),  /* env */
    ...
    {/* instance#2 */
        ...
        0,  /* stackHeap */
        ((xdc_Void(*)(xdc_UArg f_arg0,xdc_UArg f_arg1))(executePayloadTask)),  /* fxn */
        ((xdc_UArg)(0x0)),  /* arg0 */
        ((xdc_UArg)(0x0)),  /* arg1 */
        ((xdc_Ptr)NULL),  /* env */
    ...
    {/* instance#3 */
        ...
        0,  /* stackHeap */
        ((xdc_Void(*)(xdc_UArg f_arg0,xdc_UArg f_arg1))(tickerProcessingTask)),  /* fxn */
        ((xdc_UArg)(0x0)),  /* arg0 */
        ((xdc_UArg)(0x0)),  /* arg1 */
        ((xdc_Ptr)NULL),  /* env */
    ...
    {/* instance#4 */
        ...
        0,  /* stackHeap */
        ((xdc_Void(*)(xdc_UArg f_arg0,xdc_UArg f_arg1))(uart1ReadTask)),  /* fxn */
        ((xdc_UArg)(0x0)),  /* arg0 */
        ((xdc_UArg)(0x0)),  /* arg1 */
        ((xdc_Ptr)NULL),  /* env */
...
__FAR__ const CT__ti_sysbios_rts_ti_ReentSupport_Module__id ti_sysbios_rts_ti_ReentSupport_Module__id__C = (xdc_Bits16)0x31;
...
__FAR__ const CT__xdc_rov_support_ScalarStructs_Module__id xdc_rov_support_ScalarStructs_Module__id__C = (xdc_Bits16)0x13;
...
const ti_sysbios_gates_GateSwi_Handle gateSwi0 = (ti_sysbios_gates_GateSwi_Handle)((ti_sysbios_gates_GateSwi_Handle)&ti_sysbios_gates_GateSwi_Object__table__V[0]);
    ...
    __attribute__ ((used))
const ti_sysbios_knl_Task_Handle UARTReader0 = (ti_sysbios_knl_Task_Handle)((ti_sysbios_knl_Task_Handle)&ti_sysbios_knl_Task_Object__table__V[0]);

    __attribute__ ((used))
const ti_sysbios_knl_Task_Handle UARTWriter = (ti_sysbios_knl_Task_Handle)((ti_sysbios_knl_Task_Handle)&ti_sysbios_knl_Task_Object__table__V[1]);

    __attribute__ ((used))
const ti_sysbios_knl_Semaphore_Handle UARTWriteSem = (ti_sysbios_knl_Semaphore_Handle)((ti_sysbios_knl_Semaphore_Handle)&ti_sysbios_knl_Semaphore_Object__table__V[0]);

    __attribute__ ((used))
const ti_sysbios_knl_Task_Handle PayloadExecutor = (ti_sysbios_knl_Task_Handle)((ti_sysbios_knl_Task_Handle)&ti_sysbios_knl_Task_Object__table__V[2]);

    __attribute__ ((used))
const ti_sysbios_knl_Queue_Handle PayloadQueue = (ti_sysbios_knl_Queue_Handle)((ti_sysbios_knl_Queue_Handle)&ti_sysbios_knl_Queue_Object__table__V[0]);

    __attribute__ ((used))
const ti_sysbios_knl_Queue_Handle OutMsgQueue = (ti_sysbios_knl_Queue_Handle)((ti_sysbios_knl_Queue_Handle)&ti_sysbios_knl_Queue_Object__table__V[1]);

    __attribute__ ((used))
const ti_sysbios_knl_Semaphore_Handle PayloadSem = (ti_sysbios_knl_Semaphore_Handle)((ti_sysbios_knl_Semaphore_Handle)&ti_sysbios_knl_Semaphore_Object__table__V[1]);

    __attribute__ ((used))
const ti_sysbios_knl_Swi_Handle Timer0_swi = (ti_sysbios_knl_Swi_Handle)((ti_sysbios_knl_Swi_Handle)&ti_sysbios_knl_Swi_Object__table__V[0]);

    __attribute__ ((used))
const ti_sysbios_knl_Swi_Handle SW1_swi = (ti_sysbios_knl_Swi_Handle)((ti_sysbios_knl_Swi_Handle)&ti_sysbios_knl_Swi_Object__table__V[1]);

    __attribute__ ((used))
const ti_sysbios_knl_Swi_Handle SW2_swi = (ti_sysbios_knl_Swi_Handle)((ti_sysbios_knl_Swi_Handle)&ti_sysbios_knl_Swi_Object__table__V[2]);

    __attribute__ ((used))
const ti_sysbios_knl_Semaphore_Handle TickerSem = (ti_sysbios_knl_Semaphore_Handle)((ti_sysbios_knl_Semaphore_Handle)&ti_sysbios_knl_Semaphore_Object__table__V[2]);

    __attribute__ ((used))
const ti_sysbios_knl_Task_Handle TickerProcessor = (ti_sysbios_knl_Task_Handle)((ti_sysbios_knl_Task_Handle)&ti_sysbios_knl_Task_Object__table__V[3]);
...
const ti_sysbios_gates_GateSwi_Handle gateSwi3 = (ti_sysbios_gates_GateSwi_Handle)((ti_sysbios_gates_GateSwi_Handle)&ti_sysbios_gates_GateSwi_Object__table__V[3]);
    ...
    __attribute__ ((used))
const ti_sysbios_knl_Semaphore_Handle ADCSemaphore = (ti_sysbios_knl_Semaphore_Handle)((ti_sysbios_knl_Semaphore_Handle)&ti_sysbios_knl_Semaphore_Object__table__V[3]);

    __attribute__ ((used))
const ti_sysbios_knl_Task_Handle ADCStreamer = (ti_sysbios_knl_Task_Handle)((ti_sysbios_knl_Task_Handle)&ti_sysbios_knl_Task_Object__table__V[5]);
